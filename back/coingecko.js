...
const PER_PAGE = 200
const SUPPORTED_PROTOCOLS = ['ethereum', 'cronos', 'binance-smart-chain', 'xdai', 'polygon-pos', 'fantom', 'arbitrum-one', 'celo', 'avalanche', 'zksync', 'optimistic-ethereum']
...
async function buildList() {
	const MONGO_CLIENT = new MongoClient(MONGO_URL, MONGO_OPTIONS)
