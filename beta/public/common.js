...
const NETWORK = {
  ETHEREUM: {
    ...
    tokentx: 'https://api.etherscan.io/api?module=account&action=tokentx&address=WALLET_ADDRESS&startblock=START_BLOC&sort=asc',
    erc721tx: 'https://api.etherscan.io/api?module=account&action=tokennfttx&address=WALLET_ADDRESS&startblock=START_BLOC&sort=asc',
  ...
  POLYGON: {
    ...
    tokentx: 'https://api.polygonscan.com/api?module=account&action=tokentx&address=WALLET_ADDRESS&startblock=START_BLOC&sort=asc',
    erc721tx: 'https://api.polygonscan.com/api?module=account&action=tokennfttx&address=WALLET_ADDRESS&startblock=START_BLOC&sort=asc',
  ...
  BSC : {
    ...
    tokentx: 'https://api.bscscan.com/api?module=account&action=tokentx&address=WALLET_ADDRESS&startblock=START_BLOC&sort=asc',
    erc721tx: 'https://api.bscscan.com/api?module=account&action=tokennfttx&address=WALLET_ADDRESS&startblock=START_BLOC&sort=asc',
  ...
  FANTOM: {
    ...
    tokentx: 'https://api.ftmscan.com/api?module=account&action=tokentx&address=WALLET_ADDRESS&startblock=START_BLOC&sort=asc',
    erc721tx: 'https://api.ftmscan.com/api?module=account&action=tokennfttx&address=WALLET_ADDRESS&startblock=START_BLOC&sort=asc',
  ...
  XDAI: {
    ...
    tokentx: 'https://blockscout.com/xdai/mainnet/api?module=account&action=tokentx&address=WALLET_ADDRESS&startblock=START_BLOC&sort=asc',
    erc721tx: 'https://blockscout.com/xdai/mainnet/api?module=account&action=tokennfttx&address=WALLET_ADDRESS&startblock=START_BLOC&sort=asc',
